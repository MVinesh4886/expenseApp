...
addExpenseButton.addEventListener("click", async function () {
  ...
  try {
    ...
    const response = await axios.post(
      "http://54.145.12.139/expense/create",
      expense,
      {
        headers: {
    ...
    deleteButton.addEventListener("click", async function () {
      try {
        ...
        const deleteResponse = await axios.delete(
          `http://54.145.12.139/expense/delete/${expense.id}`,
          {
            headers: {
              Authorization: `Bearer ${token} `,
            },
      ...
      saveButton.addEventListener("click", async function () {
        ...
        try {
          ...
          const response = await axios.put(
            `http://54.145.12.139/expense/put/${expense.id}`,
            expense,
            {
              headers: {
                Authorization: `Bearer ${token}`,
...
async function download() {
  try {
    ...
    const response = await axios.get(`http://54.145.12.139/expense/download`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  const userLeaderboard = async (page, size) => {
    try {
      ...
      const getLeaderBoard = await axios.get(
        ...
        `http://54.145.12.139/expense/showleaderboard?page=${page}&size=${size}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  .addEventListener("click", async function (e) {
    ...
    try {
      ...
      const response = await axios.get(
        `http://54.145.12.139/order/purchasePremium`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      const options = {
        ...
        handler: async function () {
          const res = await axios.post(
            "http://54.145.12.139/order/updateTransactionStatus",
            {
